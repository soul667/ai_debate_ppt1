...
这正是为什么后面三个延展型创新（精卫/相得/烛龙）每一个都必须把信号和行动锚在人——危险不在它会想，而在它能不能脱离"人锚"去动。
-->
...
这种东西强大、有用，但也意味着——AI 现在真的能在物理世界里"动手"了。这就是为什么后面我们提出的三个延展型创新（精卫/相得/烛龙），每一个都必须以人作为锚——只有锚在场，行动才被授权。
-->
...
<Tag class="mb-10">我们的判断 · 末日论其实跳过了三步</Tag>

<div class="grid grid-cols-3 gap-5 text-left">
  <LayerCard v-click tone="amber" sub="跳跃 ①" title="能力 ≠ 动机">
    刀能切人，<br/>不代表它想切人
  </LayerCard>
  <LayerCard v-click tone="amber" sub="跳跃 ②" title="不完全理解 ≠ 失控">
    自动驾驶未必完全看懂，<br/>但仍能靠约束安全运行
  </LayerCard>
...
第二，黑箱不等于失控。飞机自动驾驶在天上飞了 70 年、每天运百万旅客、至今没出过一起重大商用事故——但没有一名工程师敢拍胸脯说"我完全理解它每一行代码为什么这么写"。黑箱从来不可怕，可怕的是不在黑箱周围加约束。我们过去 70 年做的事，就是在每一个不可解释的复杂系统外面套一套工程化约束，让它在不完美的理解下仍然安全。AI 也是同构命题——不需要"看穿它在想什么"，只需要"管住它能做什么"。
