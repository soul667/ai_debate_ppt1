...
<div class="space-y-3">
  <div v-click class="card-sky py-3">输入层接收数据 → 隐藏层逐层变换 → 输出层给出结果</div>
...
<div class="flex items-center justify-center gap-3 mb-8 text-lg flex-wrap">
...
<Punch v-click tone="emerald" size="1.6rem" class="mt-10">
对 AI 来说，语言只是一串数字
</Punch>
...
<Tag class="mt-1 mb-5">Large Language Model · 把 token + Transformer 堆到极致</Tag>
...
<Tag class="mt-1 mb-6">同一套原理，长出不同的"感官"和"手脚"</Tag>
...
<Punch v-click tone="amber" size="1.6rem" class="mt-15">
越靠近「行动」，风险越落到物理世界 —— 这正是我们物理层要"锁"的
</Punch>
...
<Tag class="mb-10">我们的判断 · 末日论藏着三次逻辑跳跃</Tag>

<div class="grid grid-cols-3 gap-5 text-left">
  <LayerCard v-click tone="amber" sub="跳跃 ①" title="能力 ≠ 动机">
    刀能切人，<br/>不代表它想切人
  </LayerCard>
  <LayerCard v-click tone="amber" sub="跳跃 ②" title="黑箱 ≠ 失控">
    不懂人脑，<br/>仍造了刑法和红绿灯
  </LayerCard>
  <LayerCard v-click tone="amber" sub="跳跃 ③" title="像 agent ≠ 有意志">
    扫地机看似探索，<br/>但它没有自我
  </LayerCard>
</div>

<Punch v-click tone="emerald" size="1.9rem" class="mt-10">
砍掉这三跳，整套末日论就塌了
</Punch>

<!--
口播（约 65 秒）：
理解了 AI 的三块基石，我们的判断是：所谓"AI 必然觉醒、必然灭绝"的末日论，藏着三次悄悄的逻辑跳跃。
...
<Tag class="mt-1 mb-8">鱼骨图 · 为 AI 定制的 7M</Tag>

<Fishbone v-click head="AI 为何危险？" :bones="[
  { k: 'Model', en: '模型', desc: '幻觉 / 泛化错误', tone: 'sky' },
  { k: 'Data', en: '数据', desc: '偏见 / 污染', tone: 'emerald' },
  { k: 'Objective', en: '目标', desc: 'reward hacking', tone: 'amber' },
  { k: 'Permission', en: '权限', desc: '工具 / 联网 / 执行', tone: 'violet' },
  { k: 'Incentive', en: '激励', desc: '竞争 / 逐利', tone: 'sky' },
  { k: 'Governance', en: '监管', desc: '滞后 / 责任不清', tone: 'emerald' },
  { k: 'Human', en: '人', desc: '误用 / 滥用', tone: 'amber' },
]" />

<Punch v-click tone="emerald" size="1.7rem" class="mt-10">
7 根骨头，6 根在模型 <span class="hl">之外</span> —— 全是工程可干预的
</Punch>
